import { HTMLElement } from "https://esm.sh/v125/linkedom@0.14.25/types/esm/index";
import { Document } from "https://esm.sh/v125/linkedom@0.14.25/types/esm/interface/document";
import { XMLDocument } from "https://esm.sh/v125/linkedom@0.14.25/types/esm/xml/document";
...
export interface IComponent extends HTMLElement {
    ...
    _messageListener: (subject:string) => boolean
