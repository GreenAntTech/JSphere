...
```
deno install --global --allow-all -f -n js https://esm.sh/gh/greenanttech/jsphere/cli.min.js
```
You can specify a specific version of the CLI tool to install by providing a version number as follows:
```
deno install --global --allow-all -f -n js https://esm.sh/gh/greenanttech/jsphere@v1.0.0/cli.min.js
```
